...
def train(args):
    ...
    with open(log_path, "w") as f:
        f.write("epoch,global_step,train_loss,val_loss,lr_main,lr_agg,bleu\n")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # ---- eval ----
        val_loss = -1.0
        if eval_loader and args.val_loss_every > 0 and epoch % args.val_loss_every == 0:
